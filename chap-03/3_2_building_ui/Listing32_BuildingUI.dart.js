...
$.main = function() {
  var title, itemInput, t1, addButton, itemContainer;
  ...
  t1 = $.getInterceptor$x(addButton);
  t1.set$id(addButton, "btn-add");
  t1.set$text(addButton, "Add");
  $.add$1$ax($.get$children$x($.get$body$x(document)), addButton);
  itemContainer = $._ElementFactoryProvider_createElement_tag("div");
  t1 = $.getInterceptor$x(itemContainer);
  t1.set$id(itemContainer, "items");
  $.set$width$x(t1.get$style(itemContainer), "300px");
  $.set$border$x(t1.get$style(itemContainer), "1px solid black");
  t1.set$innerHtml(itemContainer, "&nbsp;");
...
$.CONSTANT6 = Isolate.makeConstantList(["caption", "col", "colgroup", "tbody", "td", "tfoot", "th", "thead", "tr"]);
$.CONSTANT3 = new $.ConstantMap(9, {caption: null, col: null, colgroup: null, tbody: null, td: null, tfoot: null, th: null, thead: null, tr: null}, $.CONSTANT6);
$.CONSTANT = new $.NullThrownError();
$.CONSTANT5 = new $.Object();
$.CONSTANT2 = new $._LinkedHashTableHeadMarker();
$.CONSTANT7 = Isolate.makeConstantList(["body", "head", "caption", "td", "th", "colgroup", "col", "tr", "tbody", "tfoot", "thead", "track"]);
$.CONSTANT4 = new $.ConstantMap(12, {body: "html", head: "html", caption: "table", td: "tr", th: "tr", colgroup: "table", col: "colgroup", tr: "tbody", tbody: "table", tfoot: "table", thead: "table", track: "audio"}, $.CONSTANT7);
...
$.$defineNativeClass("HTMLInputElement", {"": "placeholder}",
  $isElement: function() {
    return true;
  },
  $asElement: function() {
...
$.$defineNativeClass("HTMLTextAreaElement", {"": "placeholder},rows="});
...
//@ sourceMappingURL=Listing32_BuildingUI.dart.js.map
