...
$$.PackItem = {"": "Object;itemText,_uiElement,_isPacked",
  get$isPacked: function() {
    return this._isPacked;
  },
  set$isPacked: function(value) {
    var t1;
    this._isPacked = value;
    if (this._isPacked) {
      t1 = $.get$classes$x(this.get$uiElement());
      t1.add$1(t1, "packed");
    } else {
      t1 = $.get$classes$x(this.get$uiElement());
      t1.remove$1(t1, "packed");
    }
  },
  get$uiElement: function() {
    if (this._uiElement == null) {
      this._uiElement = $.Element_Element$tag("div");
      var t1 = $.get$classes$x(this._uiElement);
      t1.add$1(t1, "item");
      $.set$text$x(this._uiElement, this.itemText);
      $.get$onClick$x(this._uiElement).listen$1(new $.PackItem_uiElement_anon(this));
    }
    return this._uiElement;
  }
};

$$.PackItem_uiElement_anon = {"": "Closure;this_0",
  call$1: function($event) {
    var t1, t2;
    t1 = this.this_0;
    t2 = !t1.get$isPacked();
...
$.addItem = function() {
  var itemInputList, itemInput, itemContainer, t1, packItem;
  ...
  t1 = $.getInterceptor$x(itemInput);
  packItem = $.PackItem$(t1.get$value(itemInput));
  $.add$1$ax($.get$children$x(itemContainer), packItem.get$uiElement());
  t1.set$value(itemInput, "");
};

$.PackItem$ = function(itemText) {
  return new $.PackItem(itemText, null, false);
};
...
$.$defineNativeClass("Element", {"": "$$dom_children:children=,id%,innerHtml:innerHTML},$$dom_className:className},style=,tagName=",
...
//@ sourceMappingURL=Listing37_Usingasetter.dart.js.map
