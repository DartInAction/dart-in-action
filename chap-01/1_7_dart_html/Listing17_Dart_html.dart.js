...
$$.main_anon = {"": "Closure;",
  call$1: function($event) {
    var buttonList = $.queryAll$1$x(document, "button");
    $.alert$1$x(window, "There is " + $.S(buttonList.get$length(buttonList)) + " button");
  }
};
...
//@ sourceMappingURL=Listing17_Dart_html.dart.js.map
