...
class MockData implements DataAccess {
  ...
  List<Expense> getExpensesByType(ExpenseType expenseType) { throw new UnimplementedError(); }
  Map<ExpenseType, double> getAggregatedData() { throw new UnimplementedError(); }
}
