...
$$.main_anon = {"": "Closure;",
  call$1: function(e) {
    var div = $._ElementFactoryProvider_createElement_html("<div>I am a div element</div>");
    $.add$1$ax($.get$children$x($.get$body$x(document)), div);
  }
};
...
$$._FrozenElementListIterator = {"": "Object;_list,_liblib1$_index,_current",
  moveNext$0: function() {
    var nextIndex, t1;
    nextIndex = $.$add$ns(this._liblib1$_index, 1);
    t1 = this._list;
...
$.main = function() {
  ...
  button = $.$$dom_createElement$1$x(document, "button");
  t1 = $.getInterceptor$x(button);
  t1.set$text(button, "Click me");
  t1.get$onClick(button).listen$1(new $.main_anon());
  $.add$1$ax($.get$children$x($.get$body$x(document)), button);
};
...
$.CONSTANT7 = new $.ConstantMap(9, {caption: null, col: null, colgroup: null, tbody: null, td: null, tfoot: null, th: null, thead: null, tr: null}, $.CONSTANT10);
...
$.CONSTANT8 = new $.ConstantMap(12, {body: "html", head: "html", caption: "table", td: "tr", th: "tr", colgroup: "table", col: "colgroup", tr: "tbody", tbody: "table", tfoot: "table", thead: "table", track: "audio"}, $.CONSTANT11);
$.CONSTANT6 = new $.CloseToken();
$.JSInt_methods = $.JSInt.prototype;
$.CONSTANT0 = new $.EventStreamProvider("click");
...
//@ sourceMappingURL=Listing25_CreatingElements.dart.js.map
